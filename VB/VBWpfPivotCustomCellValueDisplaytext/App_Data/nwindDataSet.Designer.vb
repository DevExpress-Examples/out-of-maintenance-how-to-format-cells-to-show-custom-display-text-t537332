...
Namespace WpfPivotCustomCellValueDisplaytext.App_Data
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal OrderDate As Date, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single, ByVal Extended_Price As Decimal, ByVal Sales_Person As String) As SalesPersonRow
                Dim rowSalesPersonRow As SalesPersonRow = (DirectCast(Me.NewRow(), SalesPersonRow))
                Dim columnValuesArray() As Object = { Country, ProductName, CategoryName, OrderDate, UnitPrice, Quantity, Discount, Extended_Price, Sales_Person}
    ...
    End Class
End Namespace
Namespace WpfPivotCustomCellValueDisplaytext.App_Data.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Country, ProductName, CategoryName, OrderDate, UnitPrice, Quantity, Discou" & "nt, [Extended Price], [Sales Person] FROM SalesPerson"
