...
Partial Public Class nwindDataSet
    ...
    Partial Public Class SalesPersonDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal OrderDate As Date, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single, ByVal Extended_Price As Decimal, ByVal Sales_Person As String) As SalesPersonRow
            Dim rowSalesPersonRow As SalesPersonRow = CType(Me.NewRow,SalesPersonRow)
            Dim columnValuesArray() As Object = New Object() {Country, ProductName, CategoryName, OrderDate, UnitPrice, Quantity, Discount, Extended_Price, Sales_Person}
...
Namespace nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WpfPivotCustomCellValueDisplaytext.Settings.Default.nwindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ProductName, CategoryName, OrderDate, UnitPrice, Quantity, Discount"& _ 
                ", [Extended Price], [Sales Person], Country"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            SalesPerson"
